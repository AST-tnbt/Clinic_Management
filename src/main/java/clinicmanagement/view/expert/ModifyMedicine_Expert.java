...
import clinicmanagement.controller.modifymedicine.expert.ExpertModifyMedicineCancelListener;
import clinicmanagement.controller.modifymedicine.expert.ExpertModifyMedicineSubmitListener;
 ...
 */
@Singleton
public class ModifyMedicine_Expert extends BaseView {

    /**
     * Creates new form AddRoom
     */
    public ModifyMedicine_Expert() {
        initComponents();
    ...
    public void setModels(
            @Named(ExpertModifyMedicineName.MEDICINE_NAME) Document name,
            @Named(ExpertModifyMedicineName.MEDICINE_ID) Document id,
            @Named(ExpertModifyMedicineName.MEDICINE_IMPORTDATE) Document importDate,
            @Named(ExpertModifyMedicineName.MEDICINE_PRICE) Document price,
            @Named(ExpertModifyMedicineName.MEDICINE_EXPIREDATE) Document exportDate,
            @Named(ExpertModifyMedicineName.MEDICINE_QUANTITY) Document quantity
    ) {
    ...
    public void setListeners(
            ExpertModifyMedicineCancelListener modifyMedicineCancelListener,
            ExpertModifyMedicineSubmitListener modifyMedicineSubmitListener
    ) {
