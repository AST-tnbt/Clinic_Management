...
import clinicmanagement.controller.modifymedicine.ModifyMedicineCancelListener_Expert;
import clinicmanagement.controller.modifymedicine.ModifyMedicineSubmitListener_Expert;
import clinicmanagement.view.manager.*;
import clinicmanagement.constant.*;
import clinicmanagement.controller.modifymedicine.ModifyMedicineCancelListener;
import clinicmanagement.controller.modifymedicine.ModifyMedicineSubmitListener;
...
public class ModifyMedicine_Expert extends BaseView {
    ...
    public void setModels(
            @Named(ModifyMedicineName_Expert.MEDICINE_NAME) Document name,
            @Named(ModifyMedicineName_Expert.MEDICINE_ID) Document id,
            @Named(ModifyMedicineName_Expert.MEDICINE_IMPORTDATE) Document importDate,
            @Named(ModifyMedicineName_Expert.MEDICINE_PRICE) Document price,
            @Named(ModifyMedicineName_Expert.MEDICINE_EXPIREDATE) Document exportDate,
            @Named(ModifyMedicineName_Expert.MEDICINE_QUANTITY) Document quantity
    ) {
    ...
    public void setListeners(
            ModifyMedicineCancelListener_Expert modifyMedicineCancelListener,
            ModifyMedicineSubmitListener_Expert modifyMedicineSubmitListener
    ) {
