...
import clinicmanagement.controller.addprescription.doctor.DoctorAddMedicalRecordShowListener;
import clinicmanagement.controller.addprescription.doctor.DoctorPrescriptionAddButtonListener;
import clinicmanagement.controller.addprescription.doctor.DoctorPrescriptionSubmitListener;
...
@Singleton
public class AddPrescriptionManagement_Doctor extends BaseView {

    /**
     * Creates new form PrescriptionManagement_Admin
     */
    public AddPrescriptionManagement_Doctor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPrescriptionManagement_Doctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPrescriptionManagement_Doctor().setVisible(true);
            }
        });
    }
    ...
    public void setModels(
            @Named(DoctorAddMedicalRecordName.P_MEDICINELIST) ComboBoxModel p_listMedicine,
            @Named(DoctorAddMedicalRecordName.P_AMOUNT) Document p_amount,
            @Named(DoctorAddMedicalRecordName.P_PRESCRIPTION) Document p_prescription
    ) {
    ...
    public void setListeners(
            DoctorAddMedicalRecordShowListener addMedicalRecordShowListener,
            DoctorPrescriptionAddButtonListener prescriptionAddButtonListener,
            DoctorPrescriptionSubmitListener prescriptionSubmitListener
    ) {
        this.addComponentListener(addMedicalRecordShowListener);
