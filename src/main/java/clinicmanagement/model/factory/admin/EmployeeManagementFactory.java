 ...
 * @author tin-ast
 */
public class EmployeeManagementFactory extends AbstractModule{
    @Provides
    @Singleton
    @Named(EmployeeManagementName.EMPLOYEE_TABLE)
    ...
    @Provides
    @Singleton
    @Named(EmployeeManagementName.EMPLOYEE_TABLE_LIST_SELECTION)
    ...
    @Provides
    @Singleton
    @Named(EmployeeManagementName.EMPLOYEE_SEARCH_INPUT)
