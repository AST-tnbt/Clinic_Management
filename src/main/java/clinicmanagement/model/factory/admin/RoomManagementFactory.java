 ...
 * @author tin-ast
 */
public class RoomManagementFactory extends AbstractModule{
    @Provides
    @Singleton
    @Named(RoomManagementName.ROOM_TABLE)
    ...
    @Provides
    @Singleton
    @Named(RoomManagementName.ROOM_TABLE_LIST_SELECTION)
    ...
    @Provides
    @Singleton
    @Named(RoomManagementName.ROOM_SEARCH_INPUT)
