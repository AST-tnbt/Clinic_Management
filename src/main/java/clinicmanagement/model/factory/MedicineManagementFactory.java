 ...
 * @author tin-ast
 */
public class MedicineManagementFactory extends AbstractModule{
    @Provides
    @Singleton
    @Named(MedicineManagementName.MEDICINE_TABLE)
    ...
    @Provides
    @Singleton
    @Named(MedicineManagementName.MEDICINE_TABLE_LIST_SELECTION)
    ...
    @Provides
    @Singleton
    @Named(MedicineManagementName.MEDICINE_SEARCH_INPUT)
