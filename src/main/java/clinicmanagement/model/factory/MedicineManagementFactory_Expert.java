 ...
 * @author tin-ast
 */
public class MedicineManagementFactory_Expert extends AbstractModule{
    @Provides
    @Singleton
    @Named(MedicineManagementName_Expert.MEDICINE_TABLE)
    ...
    @Provides
    @Singleton
    @Named(MedicineManagementName_Expert.MEDICINE_TABLE_LIST_SELECTION)
    ...
    @Provides
    @Singleton
    @Named(MedicineManagementName_Expert.MEDICINE_SEARCH_INPUT)
