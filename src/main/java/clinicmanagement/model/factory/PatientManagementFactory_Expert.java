 ...
 * @author tin-ast
 */
public class PatientManagementFactory_Expert extends AbstractModule{
    @Provides
    @Singleton
    @Named(PatientManagementName_Expert.PATIENT_TABLE)
    ...
    @Provides
    @Singleton
    @Named(PatientManagementName_Expert.PATIENT_TABLE_LIST_SELECTION)
    ...
    @Provides
    @Singleton
    @Named(PatientManagementName_Expert.PATIENT_SEARCH_INPUT)
