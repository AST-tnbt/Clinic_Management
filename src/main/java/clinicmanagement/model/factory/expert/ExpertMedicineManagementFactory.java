 ...
 * @author tin-ast
 */
public class ExpertMedicineManagementFactory extends AbstractModule{
    @Provides
    @Singleton
    @Named(ExpertMedicineManagementName.MEDICINE_TABLE)
    ...
    @Provides
    @Singleton
    @Named(ExpertMedicineManagementName.MEDICINE_TABLE_LIST_SELECTION)
    ...
    @Provides
    @Singleton
    @Named(ExpertMedicineManagementName.MEDICINE_SEARCH_INPUT)
