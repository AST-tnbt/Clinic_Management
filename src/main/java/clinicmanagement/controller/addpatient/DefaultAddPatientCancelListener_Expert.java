 ...
 * @author tin-ast
 */
public class DefaultAddPatientCancelListener_Expert implements AddPatientCancelListener_Expert {
    @Inject
    ...
    @Inject @Named(AddPatientName_Expert.P_ADDRESS)
    private Document patient_Address;
    @Inject @Named(AddPatientName_Expert.P_DAYOFBIRTH)
    private Document patient_DayOfBirth;
    @Inject @Named(AddPatientName_Expert.P_PHONENUMBER)
