...
public class DefaultDoctorAddMedicalRecordAddPrescriptionListener implements DoctorAddMedicalRecordAddPrescriptionListener {
    @Inject
    private AddPrescriptionManagement_Doctor addPrescriptionManagementDoctor;
    @Inject
    ...
    public void actionPerformed(ActionEvent e) {
        addPrescriptionManagementDoctor.setVisible(true);
