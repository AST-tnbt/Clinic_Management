...
public class DefaultMedicineManagementModifyButtonListener_Expert extends MouseAdapter implements MedicineManagementModifyButtonListener_Expert {
    @Inject
    ModifyMedicine_Expert modifyMedicineAdmin;
